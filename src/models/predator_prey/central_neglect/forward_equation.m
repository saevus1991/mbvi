...
%out = (m(3)-m(1)*m(1))*m(2)+2*(m(4)+m(1)*m(2))*m(1);
out = (m(3)-m(1)*m(1)-m(1))*m(2)+2*(m(4)+m(1)*m(2))*m(1)+m(4)+m(1)*m(2);

end

function out = m122(m)

%out = (m(5)-m(2)*m(2))*m(1)+2*(m(4)+m(2)*m(1))*m(2);
out = (m(5)-m(2)*m(2)-m(2))*m(1)+2*(m(4)+m(2)*m(1))*m(2)+m(4)+m(1)*m(2);
