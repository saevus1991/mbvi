classdef ProductBernoulliTasepPopulationBased
    ...
    % the TASEP process. In this version, each transition vector that
    % affects the intensity gets an individual scaling factor while all
    % that do not change the stemloop count get a combined one
