...
hold on
plot(alpha_t,prior_mean,'-b','linewidth',1)
plot(noise1_t,noise1_mean,'-g','linewidth',1)
plot(noise2_t,noise2_mean,'-m','linewidth',1)
plot(alpha_t,exact_mean,'-r','linewidth',1)
plot(alpha_t,exact_mean+exact_std,':r','linewidth',0.5)
plot(alpha_t,exact_mean-exact_std,':r','linewidth',0.5)
plot(alpha_t,prior_mean+prior_std,':b','linewidth',0.5)
plot(alpha_t,prior_mean-prior_std,':b','linewidth',0.5)
plot(noise1_t,noise1_mean+noise1_std,':g','linewidth',0.5)
plot(noise1_t,noise1_mean-noise1_std,':g','linewidth',0.5)
plot(noise2_t,noise2_mean+noise2_std,':m','linewidth',0.5)
plot(noise2_t,noise2_mean-noise2_std,':m','linewidth',0.5)
legend({'Prior',' $\sigma=10$','$\sigma=5$','Noiseless'},'fontsize',8,'interpreter','latex','location','south')
...
yl = get(gca,'YAxis');
set(yl,'fontsize',6);
xlabel('Time in s','fontsize',8,'interpreter','latex')
ylabel('Abundance','fontsize',8,'interpreter','latex')
print('aistas_birth_death','-depsc2')
